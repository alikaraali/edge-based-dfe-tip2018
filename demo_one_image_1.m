...
numC = 20;
load map_05.mat;  % ('Non-parametric blur map regression for depth of field extension')
load convertion.mat % ('Non-parametric blur map regression for depth of field extension')
Iuint= imread('image_05.png'); % ('Non-parametric blur map regression for depth of field extension')
